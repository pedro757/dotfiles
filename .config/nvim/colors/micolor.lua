...
local highlight_groups = {
  ...
  ["@constant.builtin"]     = { link      = 'BlueItalic' },
  ["@constant.macro"]       = { link      = 'BlueItalic' },
  ["@constant"]             = { link      = 'Fg' },
  ["@constructor"]          = { link      = 'GreenBold' },
  ["@exception"]            = { link      = 'Red' },
  ["@field"]                = { link      = 'Green' },
  ["@float"]                = { link      = 'Purple' },
  ["@function.builtin"]     = { link      = "GreenBold" },
  ["@function.macro"]       = { link      = "GreenBold" },
  ["@function"]             = { link      = 'GreenBold' },
  ["@include"]              = { link      = 'Red' },
  ["@keyword"]              = { link      = 'Red' },
  ["@keyword.operator"]     = { link      = 'Orange' },
  ["@label"]                = { link      = 'Orange' },
  ["@method"]               = { link      = 'GreenBold' },
  ["@namespace"]            = { link      = 'YellowItalic' },
  ["@none"]                 = { link      = 'Fg' },
  ["@number"]               = { link      = 'Purple' },
  ["@operator"]             = { link      = 'Orange' },
  ["@parameter"]            = { link      = 'Fg' },
  ["@parameter.reference"]  = { link      = 'Fg' },
  ["@property"]             = { link      = 'Fg' },
  ["@puntuation.bracket"]   = { link      = 'Fg' },
  ["@puntuation.delimiter"] = { link      = 'Grey' },
  ["@puntuation.special"]   = { link      = 'Blue' },
  ["@repeat"]               = { link      = 'Red' },
  ["@string"]               = { link      = 'Aqua' },
  ["@string.escape"]        = { link      = 'Green' },
  ["@string.regex"]         = { link      = 'Green' },
  ["@structure"]            = { link      = 'BlueItalic' },
  ["@symbol"]               = { link      = 'Fg' },
  ["@tag"]                  = { link      = 'Orange' },
  ["@tag.delimiter"]        = { link      = 'Green' },
  ["@type"]                 = { link      = 'Yellow' },
  ["@type.builtin"]         = { link      = 'YellowItalic' },
  ["@text"]                 = { link      = 'Green' },
  ["@text.emphasis"]        = { bold      = true },
  ["@text.underline"]       = { underline = true },
  ["@text.strike"]          = { link      = 'Grey' },
  ["@text.reference"]       = { link      = 'Red' },
  ["@text.Strong"]          = { bold      = true },
  ["@text.math"]            = { link      = 'Blue' },
  ["@text.uri"]             = { link      = 'markdownUrl' },
  ["@text.note"]            = { fg = p.bg0, bg = p.blue, bold   = true },
  ["@text.warning"]         = { fg = p.bg0, bg = p.yellow, bold = true },
  ["@text.danger"]          = { fg = p.bg0, bg = p.red, bold    = true },
  ["@variable"]             = { link      = 'Fg' },
  ["@variable.builtin"]     = { link      = 'BlueItalic' },
